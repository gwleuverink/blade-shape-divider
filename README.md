<p dir="auto"><a style="display: block;" target="_blank" rel="noopener noreferrer" href="./.github/assets/readme-top-divider.svg?raw=true&sanitize=true"><img src="./.github/assets/readme-top-divider.svg?raw=true&sanitize=true" alt="Top readme divider" title="Beautiful full width shape dividers without breaking a sweat. Ain't that tasty?" style="width: 100%;"></a></p>
